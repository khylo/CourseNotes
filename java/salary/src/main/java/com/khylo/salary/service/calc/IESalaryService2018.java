...
import com.khylo.salary.service.SalaryService;
...
@Service
@Validated
public class IESalaryService2018 extends SalaryCalculatorService {

	public static final String CountryCode="IE";
	public static final int StartYear=2018;
	public static final int EndYear=2018;
	...
	private BigDecimal uscZeroCutoff=bd("13000");
	private String[][] uscA = { {".5", "12012"}, // up to 12012
										{"2", "19372"},
										{"4.75", "70044"},
										{"8", "99999999"}};
	
	private String[][] uscS = { {".5", "12012"},
										{"2", "19372"},
										{"4.75", "70044"},
										{"8", "100000"},
										{"11", "99999999"}};
	
	private String[][] uscR = { 	{".5", "12012"},   // Reduced usc for MedicalCard holders and those over 70 iff total earnings less than 60000
										{"2", "999999"}};
	private final BigDecimal uscReducedMax = bd("60000");
	// Prsi array {employees%, employer%, max weekly earnings, prsiCredit}
	// Note this not work for people earning 38 or less per week (1976 per year)

	// TODO below
	private String[][] prsiA = { {"0", "8.5", "352", null}, // = 18304 per year
										{"4", "8.5", "376", "do prsiCredit"}, //19552 per year
										{"4", "10.5", "425", "do prsiCredit"},
										{"4", "10.75", "424", null}};
	
	private String[][] prsiS = {	{"4", "0", "500", null}};
	
	final BigDecimal[][] uscRates, uscRatesS, uscRatesReduced;
	final BigDecimal[][] prsiRates, prsiRatesS;
	
	final BigDecimal payeStdRate = bd("0.20");
	final BigDecimal payeHighRate = bd("0.40");
	
	final BigDecimal TaxCreditsS = bd("1650");
	final BigDecimal TaxCreditsA = bd("3300");
	final BigDecimal TaxCreditsD =TaxCreditsA;

	private final BigDecimal StdRateCutOffSingle = bd("33800");
	private final BigDecimal StdRateCutOffSingleParent= bd("36800");
	private final BigDecimal StdRateCutOffMarried1Income = bd("42800");
	private final BigDecimal StdRateCutOffMarried2IncomeMax = StdRateCutOffSingle.add(StdRateCutOffSingle);
	private final BigDecimal StdRateCutOffMarried2IncomeDiff = StdRateCutOffMarried2IncomeMax.subtract(StdRateCutOffMarried1Income);
	private final BigDecimal StdRateCutOffMarried2IncomesIndependentlyAssessed = null;
	private final BigDecimal StdRateCutOffMarried2IncomesJointAssesment = null;
	private final BigDecimal StdRateCutOffMarried2IncomesSingleAssesment = null;
	private final BigDecimal StdRateCutOffWidowed = null;
	...
	/**
	 * Do we need this SarayInputParams?
	 * @param s
	 * @return
	 */
