...
public class IESalaryService2025 extends SalaryCalculatorService {
	...
	private static String[][] prsiA = { {"0", "8.8", "352", null}, // = 18304 per year
										{"4", "8.8", "424", "do prsiCredit"}, //22048 per year
										{"4", "8.8", "441", null}, //22932 still 8.8%, but no prsiCredit
										{"4", "11.05", "442", null}};
	...
	public static final BigDecimal StdRateCutOffSingle = bd("44000");
	public static final BigDecimal StdRateCutOffSingleParent= bd("48000");
	public static final BigDecimal StdRateCutOffMarried1Income = bd("49000");
	//public static final BigDecimal StdRateCutOffMarried2IncomeMax = StdRateCutOffSingle.add(StdRateCutOffSingle);
	public static final BigDecimal StdRateCutOffMarried2IncomeDiff = bd(31000);//StdRateCutOffMarried2IncomeMax.subtract(StdRateCutOffMarried1Income);
